package edu.msu.stanospa.cloudhatter;
...
/**
 * Created by Paul on 3/19/2015.
 */
public class Cloud {
    private static final String MAGIC = "NechAtHa6RuzeR8x";
    private static final String USER = "stanospa";
    private static final String PASSWORD = "Potato64";
    ...
    public static class CatalogAdapter extends BaseAdapter {
         ...
         * Constructor
         */
        public CatalogAdapter(final View view, final LoadDlg dialog) {
